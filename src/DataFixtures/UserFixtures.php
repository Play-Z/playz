...
class UserFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $player = (new User())
            ...
            ->setFirstname('Player')
            ->setCountry('RU')
            ->setDescription('Hi ! I am a user of playz !')
            ->setAge(21)
            ->setGender("Femme")
            ->setRedditUsername('playz')
            ->setTwitchUsername('playz')
        ...
        $tournamentManager = (new User())
            ...
            ->setCountry('GB')
            ->setDescription('Hi ! I am one of the tournament manager of playz !')
            ->setAge(30)
            ->setGender("Femme")
            ->setRedditUsername('playz')
            ->setTwitchUsername('playz')
        ...
        $arbiter = (new User())
            ...
            ->setFirstname('Tournament')
            ->setCountry('GB')
            ->setDescription('Hi ! I am one of the arbiter manager of playz !')
            ->setAge(22)
            ->setGender("Homme")
            ->setRedditUsername('playz')
            ->setTwitchUsername('playz')
